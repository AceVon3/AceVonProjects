...
// Re-keyed 2026-06-26 when WV moved interim->scraped (+19 active = 480; per-sub_type deltas exactly WV's: PPA +10, Combinations +5, Motorcycle +1, HO-Comb +2, Mobile +1; distinct still 11). Prior 2026-06-25 IL baseline 461. Earlier note:
...
const EXPECTED: Record<string, number> = {
  "19.0001 Private Passenger Auto (PPA)": 209,
  "19.0000 Personal Auto Combinations": 72,
  "19.0002 Motorcycle": 23,
  "19.0003 Recreational Vehicle (RV)": 8,
  "19.0004 Other": 5,
  "04.0003 Owner Occupied Homeowners": 41,
  "04.0000 Homeowners Sub-TOI Combinations": 89,
...
check("active rolled filings = 480", rows.length, 480);
