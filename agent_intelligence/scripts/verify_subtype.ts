...
// Re-keyed 2026-06-29 when NH moved interim->scraped (+15 active = 495; per-sub_type deltas exactly NH's: PPA +7, Combinations +2, RV +1, HO-Comb +4, Condo +1; distinct still 11). Prior 2026-06-26 WV baseline 480. Earlier note:
...
const EXPECTED: Record<string, number> = {
  "19.0001 Private Passenger Auto (PPA)": 216,
  "19.0000 Personal Auto Combinations": 74,
  "19.0002 Motorcycle": 23,
  "19.0003 Recreational Vehicle (RV)": 9,
  "19.0004 Other": 5,
  "04.0003 Owner Occupied Homeowners": 41,
  "04.0000 Homeowners Sub-TOI Combinations": 93,
  "04.0001 Condominium Homeowners": 11,
...
check("active rolled filings = 495", rows.length, 495);
