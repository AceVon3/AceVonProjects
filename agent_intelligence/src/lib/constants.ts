...
export const AMBEST_STATES = [  // VA (06-22), OH (06-24), IL (06-25), WV (06-26), NH (06-29), VT (06-30), HI (07-01), AK (07-05), MA (07-06), ND (07-07), RI (07-07), ME (07-08), SD (07-08), DE (07-08) removed — all now scraped
  "AR", "CA", "CT", "IA", "IN", "KS", "KY",
  "MD", "MI", "MN", "MS", "MO", "NE", "NJ",
  "NY", "OK", "PA", "SC", "TN", "TX", "WI"] as const;
