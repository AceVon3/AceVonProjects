...
Progressive and Allstate timed out on "Begin Search" link click during the
combined --all-companies run and were retried in fresh processes. Mirrors
merge_or_search.py.
"""
...
RETRY_FILES = [
    OUTPUT_DIR / "ut_progressive_search.xlsx",
    OUTPUT_DIR / "ut_allstate_search.xlsx",
]
...
def main() -> int:
    ...
    retry_carriers = {"Progressive", "Allstate"}
    before = len(rows)
