"""Parse AM Best NV rate-filings PDF text into a structured CSV.

Input:  output/ambest_nv_text.txt (extracted via pypdf)
Output: tools/ambest_nv_data.csv
...
INPUT_TXT = Path("output/ambest_nv_text.txt")
OUTPUT_CSV = Path("tools/ambest_nv_data.csv")
