"""Parse AM Best AZ rate-filings PDF text into a structured CSV.

Input:  output/ambest_az_text.txt (extracted via pypdf)
Output: tools/ambest_az_data.csv
...
INPUT_TXT = Path("output/ambest_az_text.txt")
OUTPUT_CSV = Path("tools/ambest_az_data.csv")
