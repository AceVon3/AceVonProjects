...
README_LINES: list[tuple[str, str]] = [
    ...
    ("Carriers", "State Farm, GEICO, Progressive, Allstate, Travelers, Liberty Mutual (and named subsidiaries)"),
    ("Filing types kept", "Rate, Rate/Rule (Form-only and Rule-only filings excluded)"),
    ("Excluded", "New-program / new-product / 'Introduction of' filings; filings flagged 'Rate data does NOT apply to filing.' by the filer"),
    ("", ""),
    ...
    ("line_of_business", "NAIC TOI code + label, e.g. '19.0 Personal Auto'"),
