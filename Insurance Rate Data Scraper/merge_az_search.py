"""Merge per-carrier AZ search retries into az_all_companies_search.xlsx.
...
Run history:
- Initial AZ scrape (2026-05-26): MGA Insurance timed out, retried.
"""
...
MAIN = OUTPUT_DIR / "az_all_companies_search.xlsx"
RETRY_FILES = [
    OUTPUT_DIR / "az_mga_insurance_search.xlsx",
]
